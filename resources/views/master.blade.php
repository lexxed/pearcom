  ...
  <div class="container">
    <div class="nav-left">
      <a class="nav-item" href="{{ url('/') }}">
        <img src="{{ asset('img/pear_logo.png') }}" alt="{{ config('constants.brandName') }}">
      </a>
    </div>
    ...
    <div class="nav-right nav-menu">
      ...
      <a href="{{ url('https://travelpear.com.sg/') }}" class="nav-item is-tab" >
        Singapore
      </a>
      <a href="{{ url('https://truehotelvideos.com/') }}" class="nav-item is-tab">
        Hotels
      </a>    
...
<footer class="footer">
  <div class="container">
    <div class="has-text-centered">
      <p>
        <a href="{{ url('/') }}">{{ config('constants.brandName') }}&nbsp;</a>© Copyright {{ date("Y")}}
      </p>
      <p class="text-muted">
